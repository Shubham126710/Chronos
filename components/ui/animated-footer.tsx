...
import { Clock } from "lucide-react"; // Using lucide-react as requested
...
const Footer: React.FC<FooterProps> = ({
  ...
  return (
    <footer
      ref={footerRef}
      className="bg-black text-white relative flex flex-col w-full h-full justify-between lg:h-[70vh] select-none"
    >
